...
const StockPage = () => {
  ...
  const [triggerExport] = useLazyExportStockQuery();
  ...
  const handleExport = async () => {
    try {
      ...
      console.error("Error exporting stock data:", error.message);
    }
  };
  ...
  return (
    <div className="  ">
      <div className="">
        ...
        >
          <ImportComponent closeImport={closeImport} />
        </Dialog>
        ...
        >
          <CreateFormComponent handleClose={handleClose} />
        </Dialog>
        ...
        <div className="flex items-center gap-2 mt-2  justify-end ml-auto  w-[30%] ">
          ...
          <button
            ...
            className="bg-blue-500 font-medium flex items-center  justify-center text-gray-50 text-center py-2 hover:bg-blue-400 duration-500 transition-all rounded-lg w-full"
          >
          ...
          <button
            ...
            className="bg-blue-500 font-medium text-center  py-2 text-gray-50 hover:bg-blue-400 duration-500 transition-all rounded-lg w-full"
          >
            Add Stock
          </button>
        </div>
        ...
        <Grid container>
          ...
          >
            ...
            <button
              onClick={() => handleSort()}
              className={` bg-gray-50 w-auto flex items-center gap-1 text-md  cursor-pointer  px-3 py-2  rounded-lg shadow-md text-gray-500 `}
            >
              Sort
              <ImportExportIcon
                className={` ${sortActive && "text-blue-400 duration-300"} `}
              />
            </button>
